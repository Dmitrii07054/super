...
void playerDead(TObject *mario, TObject *&brick, int &brickLength,
                TObject *&moving, int &movingLength, int &score, int &level, int maxLvl);
                 ...
                 TObject *&moving, int &movingLength, int &score, int lvl, int maxLvl)
{
    ...
    default:
        createLevel(mario, brick, brickLength, moving, movingLength, score, 1, maxLvl);
        break;
    }
}
...
int main()
{
    ...
    do {
        ...
        if (mario.IsFly == FALSE && GetKeyState(VK_SPACE) < 0)
            mario.vertSpeed = -1;
        if (GetKeyState('A') < 0)
            horizonMoveMap(&mario, brick, brickLength, moving, movingLength, 1);
        if (GetKeyState('D') < 0)
            horizonMoveMap(&mario, brick, brickLength, moving, movingLength, -1);
        ...
        vertMoveObject(&mario, &mario, brick, brickLength, moving, movingLength, score, level, maxLvl);marioCollision(&mario, moving, movingLength, score, brick, brickLength, level, maxLvl);
